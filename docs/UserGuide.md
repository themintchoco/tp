...
Tutorly is a **desktop app for managing student records**, optimized for use via a Command Line Interface (CLI) while still having the benefits of a Graphical User Interface (GUI). If you can type fast, Tutorly can get your student management tasks done faster than traditional GUI apps.
...
### Locating students by name: `search`
