...
public class AttendanceUnmarkSessionCommandParserTest {
    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, AttendanceUnmarkSessionCommand.MESSAGE_USAGE);

    private final AttendanceUnmarkSessionCommandParser parser = new AttendanceUnmarkSessionCommandParser();
    ...
    public void parse_validArgs_success() {
        assertParseSuccess(
                ...
                new AttendanceUnmarkSessionCommand(
